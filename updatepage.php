...
if(isset($_POST["emp_id"]) && !empty($_POST["emp_id"])){
    ...
    if(empty($name) || empty($address) || empty($salary)){
        ...
        //$sql = "UPDATE employee SET name=?, address=?, salary=? WHERE emp_id=?";
        // $sql = "UPDATE SET employee (name, address, salary) VALUES (?, ?, ?)";
        // $sql = "UPDATE employee SET name = 'test' WHERE emp_id = 3";
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                        ...
                        <a href="project1.php" class="btn btn-secondary ml-2">Cancel</a>
                    </form>
                </div>
            </div>        
        </div>
